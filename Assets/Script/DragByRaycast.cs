...
public class DragByRaycast : MonoBehaviour
{
    ...
    [Header("Hands (drag objects)")]
    public List<Transform> handStartPoints = new List<Transform>();
    ...
    void Start()
    {
        ...
        DOVirtual.DelayedCall(0.1f, () =>
        {
            ...
            {
                handObjects[i].transform.position = handStartPoints[i].transform.position;
            }    
        });
    }
    ...
    void ClampAllHands()
    {
        foreach (Transform hand in handObjects)
        {
            ...
            hand.position = Vector3.Slerp(hand.position, pos, Time.deltaTime * 5);
        }
    }
