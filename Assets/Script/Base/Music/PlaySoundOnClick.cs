...
public class PlaySoundOnClick : MonoBehaviour
{
    ...
    {
        MusicManager.Instance.PlayOneShot(sound, MusicManager.SourceAudio.Sound);
        //VibrateManager.Instance.Haptic(MoreMountains.NiceVibrations.HapticTypes.LightImpact);
