...
public class MusicManager : MonoBehaviour
{
    ...
    //[SerializeField] private AudioClip clawMachineMusic;
    //[SerializeField] private AudioClip eggsDropMusic;
    //[SerializeField] private AudioClip seaFishingMusic;
    //[SerializeField] private AudioClip makeToyMusic;

    [Header("SOUND CLIP")]
    public AudioClip sfx_coin;
    public AudioClip sfx_lose;
    public AudioClip sfx_win;
    public AudioClip sfx_buff_sound;
    public AudioClip sfx_debuff_sound;
    public AudioClip sfx_explosion;
    public AudioClip sfx_buy;
    public AudioClip sfx_start_combat;
    public AudioClip sfx_lucky_spin;
    ...
    public void TurnMusicVolune(bool on)
    {
        ...
        if (on)
        {
            //if(!musicSource.isPlaying) PlayBGMusic();
        }
    }
    //public bool Vibrate
    //{
    ...
    private void Start()
    {
        MusicManager.Instance.PlaySingle(MusicManager.Instance.homeMusic, SourceAudio.Music);
    }
    ...
    #region === Play Sound ===
    //public bool bgMusicIsPlay => musicSource.clip == BGMusic;
    #endregion
}
