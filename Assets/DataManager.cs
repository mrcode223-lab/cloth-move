...
public static class DataManager
{
    ...
    public static void UnlockSkin(SkinType skinType)
    {
        AddOwnedSkin(skinType);
    }
    private static void LoadPurchasedSkins()
    {
        ...
        {
            firstTimeSetup = true;
            purchasedSkinIds.Add((int)SkinType.Skin1);
            SavePurchasedSkins();
        }
        else
        {
            ...
            if (!purchasedSkinIds.Contains((int)SkinType.Skin1))
            {
                purchasedSkinIds.Add((int)SkinType.Skin1);
                SavePurchasedSkins();
            }
        ...
        {
            PlayerPrefs.SetInt(SelectedSkinKey, (int)SkinType.Skin1);
            PlayerPrefs.Save();
        }
    }
